# Hi, I'm Deep Narayan Shukla 👋
### Mobile Application Architect & Android Tech Lead
...
* **Asynchronous Engine:** Advanced Kotlin Coroutines, Reactive Streams (`StateFlow`, `SharedFlow`), and low-latency background processing.
* **Modern UI:** Jetpack Compose (Declarative UI), custom graphics rendering, custom animations, and state optimization.
